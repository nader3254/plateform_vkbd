...
from gtyTools import tools, gtyLog,aboutTools
...
class MainGuiModel(QDialog, ui_mainDialog.Ui_Form):
	...
	def __init__(self, eventQ, parent=None):
		...
		# =======辅助显示========================
  		...
  		# initializing Battery from aboutTools
		self.battery=aboutTools.battery()
		print('||||||||||||||||||||||||||||||||||||||')
	...
	def updateHardwareTimePer10ms(self):
		...
		# update battery life text
			self.label_22.setText(self.battery.getLMainB_l())
